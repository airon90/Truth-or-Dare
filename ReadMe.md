...
4. Start the game
  ...
  a. **Automatic**: Go into script and click on `installAndStart.bat` to launch the app automatically in Windows.

  b. **Manual**: Use the `csv_to_json` python script to transform the file into `output.json`
